...
SDL_AtomicCAS(SDL_atomic_t *a, int oldval, int newval)
{
    ...
    return (SDL_bool) (_InterlockedCompareExchange((long*)&a->value, (long)newval, (long)oldval) == (long)oldval);
...
SDL_AtomicCASPtr(void **a, void *oldval, void *newval)
{
    ...
    return (SDL_bool) (_InterlockedCompareExchange((long*)a, (long)newval, (long)oldval) == (long)oldval);
#elif defined(HAVE_MSC_ATOMICS) && (!_M_IX86)
    return (SDL_bool) (_InterlockedCompareExchangePointer(a, newval, oldval) == oldval);
#elif defined(HAVE_WATCOM_ATOMICS)
